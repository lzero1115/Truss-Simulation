...
This python project provides the mechanical simulation of grid truss structure, which solves $Kd = \textbf{f}$ and supports 6 DoFs for each node containing stretching, torsion and bending.
